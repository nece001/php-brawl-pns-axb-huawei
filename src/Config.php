...
class Config extends ConfigAbstract
{
    public function buildTemplate()
    {
        ...
        $this->addTemplate(true, 'relationNum', '中间号码', '指定已申请到的X号码进行绑定。必须带国际区域码，例：+8613352478541');
        ...
        $this->addTemplate(false, 'http_proxy', 'http代理', '例：http://xxxx:xx');
        $this->addTemplate(false, 'https_proxy', 'https代理', '例：http://xxxx:xx');
    }
}
